...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Test Open Graph - RO-AL Mobileri',
    description: 'This is a test page to verify Open Graph meta tags are working correctly for social media sharing.',
    url: 'https://roalmobileri.com/test-og',
    type: 'website',
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <ul className="text-blue-800 space-y-1">
              <li>• Title: "Test Open Graph - RO-AL Mobileri"</li>
              <li>• Description: "This is a test page to verify Open Graph meta tags..."</li>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <ol className="text-yellow-800 space-y-1">
              <li>1. Copy this URL: <code className="bg-yellow-100 px-2 py-1 rounded">https://roalmobileri.com/test-og</code></li>
